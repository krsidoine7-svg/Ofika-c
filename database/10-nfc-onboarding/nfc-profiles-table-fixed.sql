-- =====================================================
-- MODULE 9 : ONBOARDING CARTE NFC - CORRECTION TYPE USER_ID
-- =====================================================

-- Supprimer la table si elle existe pour la recréer avec le bon type
DROP TABLE IF EXISTS nfc_profiles CASCADE;

-- Table principale pour les profils NFC (avec user_id TEXT)
