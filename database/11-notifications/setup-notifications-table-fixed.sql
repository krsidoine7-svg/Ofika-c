-- =====================================================
-- CRÉATION DE LA TABLE NOTIFICATIONS (CORRIGÉE)
-- =====================================================

-- Vérifier le type de la colonne id dans la table orders
DO $$
DECLARE
    order_id_type TEXT;
BEGIN
    ...
    RAISE NOTICE 'Type de la colonne orders.id: %', order_id_type;
END $$;

-- Créer la table notifications avec le bon type pour order_id
...
-- Créer les politiques RLS (avec nettoyage préalable)
