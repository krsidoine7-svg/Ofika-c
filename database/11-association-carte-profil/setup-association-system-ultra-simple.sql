-- =====================================================
-- SQL POUR SUPABASE - SYSTÈME D'ASSOCIATION CARTE-PROFIL (VERSION ULTRA-SIMPLE)
-- =====================================================
...
-- 6. Politiques RLS (Row Level Security) - Version ultra-simple
...
-- Politiques pour profiles (version ultra-simple)
...
-- Politiques pour links (version ultra-simple)
...
-- Politiques pour nfc_profiles (version ultra-simple)
