-- ========================================
-- Migration 001: Setup des 5 fonctionnalités Ofika (VERSION CORRIGÉE)
-- ========================================

-- 1️⃣ CRÉER LA TABLE CONTACTS (si elle n'existe pas)
-- ========================================
...
WHERE table_name IN ('contacts', 'push_subscriptions', 'contact_activities', 'user_consents')
