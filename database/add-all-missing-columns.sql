-- =====================================================
-- AJOUT COMPLET DES COLONNES MANQUANTES
-- =====================================================
-- Exécutez ce script dans l'éditeur SQL de Supabase
-- pour ajouter toutes les colonnes manquantes
...
-- 4. Ajouter des contraintes de validation pour profiles (si elles n'existent pas déjà)
DO $$
BEGIN
  -- Vérifier si la contrainte existe déjà
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE constraint_name = 'check_profiles_status' 
    AND table_name = 'profiles'
  ) THEN
    ALTER TABLE profiles ADD CONSTRAINT check_profiles_status 
