-- =====================================================
-- MIGRATION : FONCTION get_user_order_stats
-- =====================================================
...
BEGIN
    ...
    IF auth.uid()::uuid != user_uuid THEN
...
-- Vérification que la fonction a été créée
SELECT 'Fonction get_user_order_stats créée avec succès!' as message;
