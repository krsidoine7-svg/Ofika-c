-- =====================================================
-- SCRIPT NFC DATABASE - VERSION FINALE CORRIGÉE
-- =====================================================

-- Ce script corrige définitivement les problèmes de types
...
-- =====================================================
-- 2. CRÉATION DE LA TABLE NFC_PROFILES (TYPES CORRECTS)
-- =====================================================
...
-- =====================================================
-- 6. CRÉATION DES POLITIQUES RLS (CORRIGÉES)
-- =====================================================
...
SELECT 
    ...
    NOW() as timestamp,
    'Table nfc_profiles is ready for use' as message;
