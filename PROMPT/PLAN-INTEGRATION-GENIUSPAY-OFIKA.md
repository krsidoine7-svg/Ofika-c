...
> Ce fichier est conçu pour être donné à un éditeur de code assisté par IA (Cursor, Claude Code, Windsurf, Antigravity etc.) travaillant **dans le projet Ofika existant**.
